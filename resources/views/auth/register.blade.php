...
@section('container')
  <form method="POST" action="{{ route('register') }}" class="max-w-sm mx-auto mb-9 mt-9 items-center justify-center">
    ...
    <div class="mb-5">
      ...
      <input type="text" id="nama_lengkap" name="nama_lengkap" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" placeholder="Nama Lengkap" required>
    </div>
    <div class="mb-5">
