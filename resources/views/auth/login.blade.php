...
<form method="POST" action="{{ route('login') }}" class="max-w-sm mx-auto mb-9 mt-9">
  ...
  <div class="flex items-start mb-5">
    ...
    <label for="terms" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300"> <a href="/register" class="text-blue-600 hover:underline dark:text-blue-500">Belum Mempunyai Akun ?</a></label>
  </div>
